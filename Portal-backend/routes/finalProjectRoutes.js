...
router.post('/student/:studentId/final-report', auth, finalReportUpload.single('file'), async (req, res) => {
    try {
        ...
        student.finalProjectReport = finalProjectReport = {
            submissionType,
            link,
            cloudinaryUrl,
            comments,
        ...
        res.status(200).json({ message: 'Final project report submitted successfully!', finalProjectReport });
    } catch (error) {
